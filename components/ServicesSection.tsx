...
const ServicesSection = () => {
  return (
    <section
      ...
      id="services"
    >
      <p className="border border-borderColor rounded-xl px-2.5 py-0.5 font-medium  bg-white text-sm mb-4">
        What We Offer
      </p>
      <h1 className="text-center text-4xl max-lg:text-3xl font-semibold max-w-[640px]">
        Tailored solutions crafted to elevate your vision.
      </h1>
      <div className="grid grid-cols-4 max-sm:grid-cols-1 max-lg:grid-cols-2 max-sm:ml-4 w-full gap-4 mt-12">
