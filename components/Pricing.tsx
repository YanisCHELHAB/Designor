  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-light text-center text-gray-500 mb-12 max-md:text-sm">
      ...
      <motion.div
        ...
        transition={{ duration: 0.7 }}
      >
        <Card className="max-w-[350px] mx-3 bg-white">
          <CardHeader>
          ...
          <CardContent>
            <ul className="list-none space-y-3 max-md:text-sm ">
      ...
      <div className="mt-16  flex flex-col justify-center items-center">
        <div className="bg-[#f2f2f5] w-fit md:space-x-3 rounded-full px-1 py-2.5 text-sm font-medium mb-8">
          <span
            className={`px-4 py-2 rounded-full max-sm:text-xs cursor-pointer  ${
        ...
        {tab === "inclusion" && (
          <div className="flex max-md:flex-col max-md:space-y-3 justify-between items-center  md:space-x-4">
            <TabsCards
              src={sv2}
        ...
        {tab === "examples" && (
          <div className="flex justify-between items-center max-md:flex-col max-md:space-y-3 md:space-x-4">
            <TabsCards
              src={sv1}
        ...
        {tab === "saving" && (
          <div className="flex justify-between items-center max-md:flex-col max-md:space-y-3 md:space-x-5">
            <TabsCards
              src={sv6}
              title="$22,000 /mo"
