    ...
    <>
      {scrolling && (
        <motion.nav
          ...
          className={`fixed top-0 left-1/2 bg-white z-50 w-[800px] max-lg:w-[95%] px-2 rounded-2xl border border-gray-400 py-2 shadow-md transition duration-1000 flex justify-between items-center `}
        >
      ...
      {expanded && (
            <section className="bg-white z-[999] w-screen h-screen fixed overflow-hidden top-0 left-0">
              <div className="py-8 flex flex-col flex-grow">
                ...
                <div className="flex flex-col mt-10 max-md:mt-2 text-sm md:text-base h-[75vh] justify-between ">
                  <ul
                    className="list-none space-y-1 "
                    onClick={() => NavigatetoSection()}
                  >
                    <li className="hover:bg-[#f2f2f5] px-4 py-2 cursor-pointer">
                      <a href="./#services">Services</a>
                    </li>
                    <li className="hover:bg-[#f2f2f5] px-4 py-2 cursor-pointer">
                      <a href="./#case">Case</a>
                  ...
                  <Button
                    variant={"default"}
                    className=" text-white flex self-center w-[80%] bg-gray-800 md:text-base md:w-[90%] hover:bg-gray-900"
                  >
                    Remix template
                  </Button>
                </div>
