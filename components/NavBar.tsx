...
const NavBar = () => {
  ...
  return (
    ...
    >
      ...
      {expanded && (
        <section className="bg-white z-[999] w-screen h-screen fixed overflow-hidden top-0 left-0 m-0 ">
          <div className="py-8 flex flex-col flex-grow">
            ...
            <div className="flex flex-col mt-10 max-md:mt-5 text-sm md:text-base h-[75vh] justify-between ">
              <ul
