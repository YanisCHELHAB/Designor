...
export default function Home() {
  return (
    <>
      ...
      <ScrollNavBar />
      <section
        className={`mx-44 border border-gray-300 bg-white h-[1400px] rounded-3xl ${instrument_Sans.className} border-x-2 border-white  `}
      >
        <div className="flex flex-col justify-center items-center mx-36 mt-20 ">
          ...
          <p className="mt-20 text-gray-600">Featured highlights of our Work</p>
        </div>
        <div className="overflow-hidden whitespace-nowrap flex mt-8 mx-16">
